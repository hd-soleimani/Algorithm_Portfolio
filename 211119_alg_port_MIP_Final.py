...
for f in metadata_csv:
    ...
    ws.write(0, 7, 'Shanon_eps_'+str(epsilon), style0)
    ...
    #for iter in range (29,30):
        ...
        #for c in range (1,3):
            ...
            #columns_s = [int(s) for s in selected_algorithms]
            ...
            for i in range(0,n_test):
                ...
                tmp_prediction_objective=np.min(test.iloc[i,:-1][(s for s in selected_algorithms)])
                ...
                #print(prediction_objective,tmp_prediction_objective,np.min(test.iloc[i,:-1]))
            ...
            for i in selected_algorithms:
                tmp_index_MIP.append(int(i))

            shanon_MIP[c-1]=shanon (tmp_index_MIP,performances,p,shanon_best)
        ...
        ws.write(iter, 7, shanon_MIP_mean, style0)


        
    #wb.save('Results_OPT_'+str(f)+'.xls')
